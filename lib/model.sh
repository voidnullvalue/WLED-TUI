...
declare -A DEV_PRESETS_FETCH_CYCLE=()
...
model_remove_device() {
  ...
  unset DEV_GET_PRESETS_INFLIGHT_PID[$id] DEV_PRESETS_FETCH_CYCLE[$id] DEV_GET_EFFECTS_INFLIGHT_PID[$id] DEV_GET_PALETTES_INFLIGHT_PID[$id]
